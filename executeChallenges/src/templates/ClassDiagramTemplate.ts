export const detectClassesLogic = `public static String printPrimitive(String prim){
...
export const detectClassesMain = (classNames: string):string => `System.out.println("\\"classDiagram\\": [");
