        ...
        <div className={`w-2/4 ${rightPanelActive? 'transform -translate-x-0 duration-500 z-10': 'transform translate-x-full duration-500 opacity-0 z-0'}`}>
          <form className="flex flex-wrap flex-col align-middle text-center justify-center py-14 px-7">
            ...
            <div className="w-full flex justify-center">
              <button className="rounded-2xl border-solid bg-gradient-to-r from-auth to-auth_secondary text-white font-bold uppercase border border-auth py-3 px-11 focus:scale-90 w-6/12 transform transition duration-500 hover:scale-110" onClick={(e)=>e.preventDefault()}>Sign In</button>
            </div>
          </form>
        </div>
        <div className={`w-2/4 ${rightPanelActive? 'transform -translate-x-full duration-500 opacity-0 z-0': 'transform translate-x-0 duration-500 z-10'}`}>
          <form className="flex flex-wrap flex-col align-middle justify-center py-14 px-7">
            ...
            <div className="w-full flex justify-center mt-4">
              <button className="rounded-2xl border-solid bg-gradient-to-l from-auth to-auth_secondary text-white font-bold uppercase border border-auth py-3 px-11 focus:scale-90 w-6/12 transform transition duration-500 hover:scale-110" onClick={(e)=>e.preventDefault()}>Sign Up</button>
            </div>
          </form>
        </div>
      ...
      <div className="md:hidden md:w-2/4 h-full w-10/12">
        <div className="bg-white shadow-xl min-h-[400px] m-auto sm:w-full flex justify-center flex-col relative align-middle rounded-2xl overflow-hidden">
          ...
          <div className="flex flex-row h-full relative w-full justify-center">
            <form className={`left-0 flex flex-wrap flex-col align-middle text-center absolute justify-center py-7 px-7 w-full md:w-5/6 xl:w-4/6 ${!rightPanelActive? 'transform -translate-x-full duration-500 opacity-0 z-0': 'z-10 transform translate-x-0 duration-500'}`}>
              <h1 className="font-bold text-4xl mb-3">Sign in</h1>
              <input className="bg-gray-200 border-none m-2 p-3" type="email" placeholder="Email" />
              <input className="bg-gray-200 border-none m-2 p-3"  type="password" placeholder="Password" />
              <a className="text-sm m-4" href="#">Forgot your password?</a>
              <div className="w-full flex justify-center">
                <button className="rounded-2xl border-solid bg-gradient-to-r from-auth to-auth_secondary text-white font-bold uppercase border py-3 px-11 focus:scale-90 transform transition duration-500 hover:scale-110" onClick={(e)=>e.preventDefault()}>Sign In</button>
              </div>
            </form>
            <form className={`flex flex-wrap flex-col align-middle text-center justify-center py-7 px-7 w-full md:w-5/6 xl:w-4/6 ${rightPanelActive? 'transform translate-x-full duration-500 opacity-0 z-0 left-0': 'z-10 transform translate-x-0 duration-500'}`}>
              <h1 className="font-bold text-4xl mb-3">Sign Up</h1>
              <input className="bg-gray-200 border-none m-2 p-3" type="text" placeholder="First Name" />
              <input className="bg-gray-200 border-none m-2 p-3"  type="text" placeholder="Last Name" />
              <input className="bg-gray-200 border-none m-2 p-3" type="email" placeholder="Email" />
              ...
              <input className="bg-gray-200 border-none m-2 p-3"  type="password" placeholder="Confirm Password" />
              <div className="w-full flex justify-center mt-4">
                <button className="rounded-2xl border-solid bg-gradient-to-l from-auth to-auth_secondary text-white font-bold uppercase border py-3 px-11 focus:scale-90 transform transition duration-500 hover:scale-110" onClick={(e)=>e.preventDefault()}>Sign Up</button>
              </div>
            </form>
          </div>
        </div>
